...
<Link className='border-bottom border-2 border-danger' to={"/resident/eventparticipation"}>  <button className="participatebtn hovermaincolor rounded-top bg-white text-dark btn border-bottom ">
  <span className='participatebtnspan'>Events Participate</span></button></Link> 
<Link className='border-bottom border-2 border-danger' to="/resident/activityparticipate"><button  className="participatebtn text-white  mainColor2 hovermaincolor border-bottom text-dark bg-white rounded-top  btn">
