              ...
              <div className="row mt-2 mx-2" key={index}>
                ...
                <div className="col-2 py-2 d-flex gap-3 justify-content-center action_btn_main">
                  ...
                  <button
                    ...
                    data-bs-toggle="modal"
                    data-bs-target="#viewProtocolModal"
                  >
                  ...
                  <button
                    ...
                    data-bs-toggle="modal"
                    data-bs-target="#deleteProtocolModal"  // Add this line
                  >
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content custom-modal">
            <div className="modal-header">
              <h5 className="modal-title" id="addProtocolModalLabel">
            ...
            <div className="modal-body">
              <form onSubmit={handleSave}> {/* Add onSubmit here */}
                ...
                <div className="row">
                  ...
                  <div className="col-6 mb-3">
                    <label htmlFor="time" className="form-label">Time <FaStarOfLife className='star_icon_modal mb-2' /></label>
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content custom-modal">
            <div className="modal-header  mb-0">
              <h5 className="modal-title" id="viewProtocolModalLabel "> View Security Protocol</h5>
            ...
            <div className="modal-body mt-0">
              {viewProtocol && (
                <div>
                  <div className="col-12">
                    <p><strong className='viewPageLabel'>Title </strong><br /> {viewProtocol.title}</p>
                  </div>

                  <p><strong className='viewPageLabel'>Description</strong> <br />{viewProtocol.description}</p>
                  <div className='d-flex '>
                    <div className="col-5">
                      <p><strong className='viewPageLabel'>Date</strong><br /> {formattedDate(viewProtocol.date)}</p>
                    </div>
                    <div className="col-5">
                      <p><strong className='viewPageLabel '>Time</strong> <br />  {viewProtocol.time} </p>
                    </div>
