...
//       if (isEditing) {
//        // Editing an Expense
//         const response = await axios.put(`${API_URL}/update/${expenses[currentExpenseIndex]._id}`, form);
//         const updatedExpenses = [...expenses];
//         updatedExpenses[currentExpenseIndex] = response.data;
...
//       // Update the UI by removing the deleted expense from the list
...
//               <div className="col-3 py-2"><h6 className='text-start'>Description</h6></div>
